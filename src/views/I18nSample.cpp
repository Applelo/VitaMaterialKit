...
void I18nSample::contents() {
    ...
    ui->texts->draw(10, 10, Body1, TEXT_PRIMARY, utils->i18n->getI18nByCat("test")["phrase"]);
    ui->texts->draw(10, 60, Body1, TEXT_PRIMARY, frLang->getI18nByCat("test")["phrase"]);
    ui->texts->draw(10, 110, Body1, TEXT_PRIMARY, enLang->getI18nByCat("test")["phrase"]);
